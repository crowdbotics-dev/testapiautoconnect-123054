...
## Project Structure
    ...
    ├── testapiautoconnect_123054  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_123054`
...
2. Clone this repo and `cd testapiautoconnect_123054`
